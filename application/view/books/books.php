		...
		<section id="book_list container">
			...
			<div class="grid-shuffle">
				<ul id="grid" class="row">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic"]' data-date-created='1937' data-title='Of Mice and Men'
					 data-color='#fcc278'>
						<div class="bk-img">
						...
						<div class="overlay-details">
							...
							<div class="overlay-image">
								<img src="/img/landing-book.png" alt="Book Cover">
							...
							<div class="overlay-desc activated">
								...
								<p class="synopsis">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam luctus convallis sem. Nunc sed tristique augue. Aenean
									at nulla vel lacus volutpat bibendum vitae ut nibh. Aliquam eu metus et purus rutrum malesuada. Aenean in auctor
									mauris, non vulputate libero. Nullam auctor, purus ut cursus convallis, lectus tellus dignissim lectus, id tempor
									ipsum leo ut nulla. Vestibulum vitae elit erat.</p>
							...
							<div class="overlay-preview">
								...
								<div class="preview-content">
									<h5>Chapter 1</h5>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam luctus convallis sem. Nunc sed tristique augue. Aenean
										at nulla vel lacus volutpat bibendum vitae ut nibh. Aliquam eu metus et purus rutrum malesuada. Aenean in auctor
										mauris, non vulputate libero. Nullam auctor, purus ut cursus convallis, lectus tellus dignissim lectus, id tempor
										ipsum leo ut nulla. Vestibulum vitae elit erat.</p>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam luctus convallis sem. Nunc sed tristique augue. Aenean
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam luctus convallis sem. Nunc sed tristique augue. Aenean
										at nulla vel lacus volutpat bibendum vitae ut nibh. Aliquam eu metus et purus rutrum malesuada. Aenean in auctor
										mauris, non vulputate libero. Nullam auctor, purus ut cursus convallis, lectus tellus dignissim lectus, id tempor
										ipsum leo ut nulla. Vestibulum vitae elit erat.
										<br>&nbsp;
										<br>&nbsp;</p>
								</div>
							</div>
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","young"]' data-date-created='1951' data-title='The Catcher in the Rye'
					 data-color='#009c8b'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","sci-fi"]' data-date-created='1949' data-title='1984'
					 data-color='#9c9688'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","young"]' data-date-created='1954' data-title='Lord of the Flies'
					 data-color='#db2e0f'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic"]' data-date-created='1925' data-title='The Great Gatsby'
					 data-color='#e3b005'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic"]' data-date-created='1851' data-title='Moby Dick'
					 data-color='#a9afad'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","sci-fi"]' data-date-created='1962' data-title='A Clockwork Orange'
					 data-color='#fe7b21'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","fairy"]' data-date-created='1835' data-title='The Princess and the Pea'
					 data-color='#aea98c'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","fairy"]' data-date-created='1900' data-title='The Wonderful Wizard of Oz'
					 data-color='#705e1e'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","fairy"]' data-date-created='1934' data-title='Mary Poppins'
					 data-color='#939894'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","fairy"]' data-date-created='1740' data-title='Beauty and the Beast'
					 data-color='#b4aa91'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["classic","fairy"]' data-date-created='1812' data-title='Rapunzel'
					 data-color='#725d64'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["fantasy","young"]' data-date-created='1997' data-title="Harry Potter and the Sorcerer's Stone"
					 data-color='#7a4930'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["fantasy","young"]' data-date-created='1998' data-title='Harry Potter and the Chamber of Secrets'
					 data-color='#800020'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["fantasy","young"]' data-date-created='1999' data-title="Harry Potter and the Prisoner of Azkaban"
					 data-color='#603060'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["fantasy","young"]' data-date-created='2000' data-title="Harry Potter and the Goblet of Fire"
					 data-color='#9a9c43'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["fantasy","young"]' data-date-created='2003' data-title="Harry Potter and the Order of the Phoenix"
					 data-color='#2c63a0'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["fantasy","young"]' data-date-created='2005' data-title="Harry Potter and the Half-Blood Prince"
					 data-color='#658539'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
					...
					<li class="book-item small-12 medium-6 columns" data-groups='["fantasy","young"]' data-date-created='2007' data-title="Harry Potter and the Deathly Hallows"
					 data-color='#b06010'>
						<div class="bk-img">
							<div class="bk-wrapper">
								<div class="bk-book bk-bookdefault">
